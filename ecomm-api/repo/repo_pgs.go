...
func createOrder(ctx context.Context,tx pgx.Tx,o *Order) (*Order,error){
	...
	err:=tx.QueryRow(ctx,query,o.PaymentMethod,o.TaxPrice,o.ShippingPrice,o.TotalPrice).Scan(&o.ID)
	if err!=nil{
...
func (pgs *PgsRepo) ListOrders(ctx context.Context) ([]Order,error){
	...
	itemQuery:="SELECT * FROM order_items WHERE order_id=ANY($1)"
...
func (pgs *PgsRepo) DeleteOrder(ctx context.Context,id int64) error{
	err:=pgs.execTx(ctx,func(tx pgx.Tx) error {
		...
		if tag.RowsAffected()==0{
    		return pgx.ErrNoRows // Or your own custom NotFound error
		}
...
func (pgs *PgsRepo) execTx(ctx context.Context,fn func(pgx.Tx) error) error{
